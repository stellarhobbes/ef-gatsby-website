        ...
        <div className="text-center">
          ...
          <Fade top>
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              ...
              Créez-vous une vie sur-mesure en devenant Entrepreneur
              </span>
            </h1>
          </Fade>
          <p className="mt-3 px-10 max-w-md mx-auto text-base text-ef-blue sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Grâce aux formations de l’Entreprenariat Français, développez vos
            compétences pour lancer une activité rentable - et qui fait sens
            pour vous - en moins de x semaines.
          </p>
          <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
            <div className="rounded-md">
              <HeadShake appear={true} delay={1000}>
                ...
                >
                  Je veux entreprendre et changer de vie !
                </Link>
              </HeadShake>
